...
URL : GET http://localhost:8082/v2/engine?fuelType=<fueltype>
### Sample request
```
http://localhost:8082/v2/engine?fuelType=WOOD
```
### Sample success response
```
{
...
#### Feature overview
![alt text](https://github.com/tommyhutomo/worldline-tech-assessment/blob/master/v.2/enginesvc/image/featureOverview.PNG?raw=true)
